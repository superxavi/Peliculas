...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__chunk" src="../template/dist/img/Grupo5.jpg" alt="AdminLTELogo" height="20%"
                width="10%">
                <h1>Alquiler de peliculas Piratas</h1>
        </div>
        <!-- Navbar -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Grupo 5</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../template/dist/img/Grupo5.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Somos Piratas de Peliculas</a>
                    </div>
                </div>
